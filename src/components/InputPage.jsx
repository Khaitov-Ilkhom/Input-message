...
const InputPage = () => {
  return (
    <div className="w-full h-screen bg-blue-500 flex justify-center items-center">
      <form action="https://input-message-black.vercel.app/send-message" method="post" className="w-[400px] min-h-[300px] flex justify-center items-center flex-col bg-white rounded-2xl">
